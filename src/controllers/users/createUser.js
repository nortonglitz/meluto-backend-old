...
var createUser = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var firstName, lastName, email, password, userExists, newUser, _a, _b, _c, _deletePassword, __v, userInfo, err_1;
    var _d, _e;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 3: return [4 /*yield*/, _b.apply(_a, [(_d.password = (_e.value = _f.sent(),
                        _e),
                        _d)])];
            case 4:
                newUser = _f.sent();
                _c = newUser.toObject(), _deletePassword = _c.password, __v = _c.__v, userInfo = __rest(_c, ["password", "__v"]);
                return [2 /*return*/, res.status(200).json({
                        message: 'User created',
                        user: __assign({}, userInfo)
                    })];
            case 5:
                err_1 = _f.sent();
